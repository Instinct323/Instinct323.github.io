...
export interface ContentImageResponsive {
  src: string;
  /**
   * @deprecated This field carries a single-value srcset placeholder. The real multi-value
   * srcset is generated by `createImageVariantSet` at render time. Consumers should
   * call `createImageVariantSet` and use the returned `srcset` instead.
   */
  srcset: string;
  format: string;
  quality: number;
