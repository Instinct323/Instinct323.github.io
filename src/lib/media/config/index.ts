import { assertStrictlyIncreasingPositiveWidths, IMAGE_MEDIUM_WIDTHS_KEY, IMAGE_HIGH_WIDTHS_KEY, selectCandidateWidthsByPolicy } from '../responsive';
...
import { normalizeContentImagePath } from '../resolution';
import { computeCarouselInferredWidths } from '../responsive';
