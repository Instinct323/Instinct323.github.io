import { loadMediaConfig } from '../../loaders/config-loader';
import { ABOUT_AVATAR_SIZES } from '../../loaders/content-paths';
import { createGridSizesString, MOBILE_BREAKPOINT } from '../responsive';
import { createCachedLoader } from '../../utils/cache';
import { assertMediaConfigShape, getValidatedHomepageGalleryConfig } from '../config';
import { computeGalleryWidthsFromGrid } from '../responsive';
import {
  IMAGE_MEDIUM_WIDTHS_KEY,
  selectCandidateWidthsByPolicy,
} from '../responsive';
import type { MediaConfig } from '../../../types/site';
import type { ContentImage, ContentImageOptions, FeaturedSlide, ImageLoader, MediaImage, MediaTree } from '../../../types/media';
import { loadContentImageResolved, createImageVariantSet } from '../resolution';
import { loadMediaTreeFromGallery } from '../../loaders/media-tree';
