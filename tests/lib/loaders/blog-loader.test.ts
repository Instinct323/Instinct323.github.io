...
describe('compareByWeightAndDate', () => {
  ...
  it('places null dates before non-null dates at same weight', () => {
    ...
    expect(compareByWeightAndDate(a, b)).toBeLessThan(0); // null date comes first
  });
